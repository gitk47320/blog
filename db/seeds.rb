...
User.find(1).posts.create(title: 'はじめまして', post: 'ブログはじめました')
...
User.find(2).posts.create(title: '自己紹介的なもの', post: 'ブログはじめました。私について知ってほしいです。')
...
User.find(3).create_profile(nickname: 'テスト３',selfintro: 'とうとうブログをはじめました！よろしくですー')
